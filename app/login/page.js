...
//  // Populate form for edit
  ...
  //     try {
  //       const response = await fetch('http://localhost:3000/api/userCRUD/read'); // Update with your endpoint
  ...
  //   try {
  //     const url = 'http://localhost:3000/api/restaurantCRUD/create';
  //     const method = 'POST';
  ...
  //       setForm({ name: '', email: '', password: '1', address: '' });
  //     } else {
  ...
  return (
    <div className='bg-blue-6000 container mx-auto w-4/5'>
      ...
      <div>
        {/* <h1 className="font-bold text-4xl mx-8 my-4 text-center">User Information</h1> */}

        <div className="bg-slate-800 opacity-90 drop-shadow-2xl mx-auto my-4 max-sm:mx-4 max-w-4xl rounded-xl text-white">
      ...
      <h1 className='text-center text-3xl font-bold  py-5'>Or continue with</h1>
      <div className="loginButtons">


        <div className="flex flex-col gap-2 max-h-screen items-center bg-slate-8000 pb-10 bg-opacity-50">



          <button onClick={() => { signIn("github") }}
            className="flex items-center bg-slate-300 border w-52 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <button className=" opacity-50 flex items-center bg-slate-300 border w-52 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <Link href={'/'}> <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Back to Home</button></Link>
