...
const page = () => {
  ...
  return (
    <div className='w-[83%] max-lg:w-[65%] max-sm:w-[65%] bg-slate-600 bg-opacity-75 rounded-lg'>
      ...
      <div>
        <h1 className='font-bold text-2xl mx-8 my-4'>User Information</h1>
        ...
        <div className="table w-[80%] mx-auto bg-slate-600 border border-slate-600 rounded-lg bg-opacity-80 drop-shadow-2xl">
          <div className="head w-full rounded-t-lg p-4 font-bold bg-slate-800 flex justify-around gap-1">
            ...
            <h1 className='w-[30%] text-center'>Address</h1>
          </div>
          ...
          {userInfo.map((userInfo) => (
            ...
            >
              <h3 className='w-[10%] text-center'>{userInfo.id}</h3>
              <h3 className='w-[30%] text-center'>{userInfo.name}</h3>
              <h3 className='w-[30%] text-center'>{userInfo.email}</h3>
              <h3 className='w-[30%] text-center'>{userInfo.address}</h3>
            </div>
            ))}
          </div>
        </div>
